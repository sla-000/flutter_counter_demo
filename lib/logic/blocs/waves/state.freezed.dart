...
mixin _$WavesState {
  ...
  @JsonKey(ignore: true)
  $WavesStateCopyWith<WavesState> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WavesStateCopyWith<$Res> {
  factory $WavesStateCopyWith(WavesState value, $Res Function(WavesState) then) = _$WavesStateCopyWithImpl<$Res>;
...
abstract class _$WavesStateCopyWith<$Res> implements $WavesStateCopyWith<$Res> {
  factory _$WavesStateCopyWith(_WavesState value, $Res Function(_WavesState) then) = __$WavesStateCopyWithImpl<$Res>;
  @override
  $Res call({int count, int waveTime});
}

/// @nodoc
class __$WavesStateCopyWithImpl<$Res> extends _$WavesStateCopyWithImpl<$Res> implements _$WavesStateCopyWith<$Res> {
  __$WavesStateCopyWithImpl(_WavesState _value, $Res Function(_WavesState) _then)
...
class _$_WavesState implements _WavesState {
  ...
  @JsonKey(ignore: true)
  @override
  _$WavesStateCopyWith<_WavesState> get copyWith => __$WavesStateCopyWithImpl<_WavesState>(this, _$identity);
}
